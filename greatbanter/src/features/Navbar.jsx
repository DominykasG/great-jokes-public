...
export default function Navbar() {
    ...
    useEffect(async () => {
        let userData = await axios.get('https://localhost:44310/api/users/current', { withCredentials: true });
        ...
        <div className="navbar navbar-dark bg-dark">
            <div className="container-fluid">
                <div className="row w-100">
                    <div className="text-light col-3  d-flex align-items-center justify-content-start">
                        <div className="font-weight-bold"><h3>GREAT BANTER REMASTERED</h3></div>
                    </div>
                    <div className="col-2 d-flex align-items-center justify-content-center icon-size">
                    ...
                    </div>
                    {
                        !user ? (
                            ...
                            <div className="col-5 d-flex align-items-center">
                                <div className="row w-100">
                                    <div className="col-4 d-flex align-items-center justify-content-center icon-size">
